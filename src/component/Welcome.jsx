  ...
  return (
    <div className='h-full pb-5'>
        <div className='text-center mt-10'>
            ...
            <p id='name' className=' text-3xl p-2 font-bold font-serif text-slate-400 opacity-0 '>GMSANI</p>
            <p id='develp' className='intro1 text-[13px] text-slate-200 opacity-0'>Front-End Developer</p>
            ...
            <div id='pic' className='opacity-0 bg-gradient-to-t from-[#0A1D56] to-[#492E87] h-auto w-[20vw] align-middle m-auto rounded-t-full mt-10'>
